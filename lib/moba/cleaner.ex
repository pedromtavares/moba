defmodule Moba.Cleaner do
  ...
  def cleanup_old_records do
    ...
    # sets current_pve_hero_id of all inactive users to nil after a week
    query =
    ...
    # sets current_pve_hero_id of all inactive guests to nil after a day
    ...
    # archives all guest heroes after a day
    query =
      from h in Hero,
